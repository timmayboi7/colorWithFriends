...
- `android/` – Jetpack Compose preview app with an interactive coloring canvas, region fills, undo/reset controls, quick palette swatches, and full-spectrum sliders to explore the painting experience.
